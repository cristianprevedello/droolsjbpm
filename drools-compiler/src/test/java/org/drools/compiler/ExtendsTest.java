...
public class ExtendsTest extends TestCase {
    ...
    public StatefulKnowledgeSession genSession(String[] sources, int numerrors)  {
        ...
        assertEquals(numerrors, kbuilder.getErrors().size() );
    ...
    public void testExtends() throws Exception {
        //Test Base Fact Type
        StatefulKnowledgeSession ksession = genSession("testExtends.drl");
    ...
    public void testIllegalExtendsLegacy() throws Exception {
        //Test Base Fact Type
        genSession("testExtLegacyIllegal.drl",1);
    ...
    public void testExtendsLegacy() throws Exception {
     ...
     public void testExtendsAcrossFiles() throws Exception {
        StatefulKnowledgeSession ksession = genSession(new String[] {"testExt1.drl","testExt2.drl","testExt3.drl","testExt4.drl"} ,0);
     ...
     public void testFieldInit() throws Exception {
        StatefulKnowledgeSession ksession = genSession("testExtFieldInit.drl");
    ...
    public void testHierarchy() throws Exception {
        StatefulKnowledgeSession ksession = genSession("testExtHierarchy.drl");
